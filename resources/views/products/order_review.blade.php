    ...
    <div class="container">
        ...
        <form name="paymentForm" id="paymentForm" action="{{url('/place-order')}}" method="post"> {{csrf_field()}}
            ...
            <div class="payment-options">
                ...
                <span>
                    <label><input type="radio" checked name="payment_method" id="COD" value="COD"><strong> Cash on Delivery (COD) </strong></label>
                </span>
                <span>
                    <label><input type="radio" name="payment_method" id="Online" value="online"><strong> PAY NOW</strong></label>
                </span>
